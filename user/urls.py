...
urlpatterns = [
	path('', views.UserSignupView.as_view(), name="user_api_view"), # 조회, 수정, 삭제 등 user의 기본적인 api담당
	path('<obj_id>/', views.UserSignupView.as_view(), name="user_api_view"), # signup 등 user의 기본적인 api담당
